...
export default function LegalFooter() {
  return (
    <footer className="px-4 pb-6 pt-3 sm:px-6">
      <div className="mx-auto max-w-7xl rounded-[22px] border border-[#d7e0e6] bg-[linear-gradient(180deg,#ffffff_0%,#eef3f6_100%)] px-4 py-3 shadow-[0_12px_26px_rgba(118,126,133,0.08)]">
